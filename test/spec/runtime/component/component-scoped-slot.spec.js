...
describe('Component scoped slot', () => {
    ...
    it('fallback content', () => {
        ...
        expect(replaceComent(vm.$el.innerHTML)).toBe('<span>hello fallback</span>');
    });

    // it('slot with a-for', done => {
    //     const vm = new Vue({
    //         template: `
    //             <test ref="test">
    //                 <template slot="item" scope="props">
    ...
    //                 template: `
    //                     <div>
    //                         <slot a-for="item in items" name="item" :text="item"></slot>
    //                     </div>
    //                 `
    //             }
    //         }
    ...
    it('scoped slot without scope alias', () => {
        ...
        expect(replaceComent(vm.$el.innerHTML)).toBe('<span>I am static</span>');
    });
    ...
    it('non-scoped slot with scope alias', () => {
        ...
        expect(replaceComent(vm.$el.innerHTML)).toBe('<span>meh</span>');
    });
    ...
    //                 template: `
    //                     <div>
    //                         <slot a-for="item in items" name="item" :text="item" :key="item"></slot>
    //                     </div>
    //                 `
    //             }
    //         }
    ...
    // #5615
//     it('scoped slot with a-for', done => {
//         const vm = new Vue({
//             data: { names: ['foo', 'bar'] },
//             template: `
//                 <test ref="test">
//                     <template a-for="n in names" :slot="n" scope="props">
//                         <span>{{ props.msg }}</span>
//                     </template>
