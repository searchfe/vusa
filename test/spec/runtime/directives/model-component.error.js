...
describe('Directive a-model component', () => {
    // it('should work', done => {
    //     const vm = new Vue({
    //         data: {
    //             msg: 'hello',
    ...
    //             <div>
    //             <p>{{ msg }}</p>
    //             <test a-model="msg" @update="spy"></test>
    //             </div>
    //         `,
    //         components: {
    //             test: {
    ...
    // it('modifier: .number', () => {
    //     const vm = new Vue({
    //         template: '<div><my-input ref="input" a-model.number="text"></my-input></div>',
    //         data: {
    //             text: 'foo',
    //         },
    //         components: {
    ...
    // it('modifier: .trim', () => {
    //     const vm = new Vue({
    //         template: '<div><my-input ref="input" a-model.trim="text"></my-input></div>',
    //         data: {
    //             text: 'foo',
    //         },
    //         components: {
