...
describe('Directive a-for', () => {
    ...
    //         Vue.set(vm.obj, 'd', 4);
    //     }).then(() => {
    //         expect(replaceComent(vm.$el.innerHTML)).toBe('<span>3</span><span>1</span><span>2</span><span>4</span>');
    //         Vue.delete(vm.obj, 'a');
    //     }).then(() => {
    ...
    //     vm.obj.a = 3;
    //     waitForUpdate(() => {
    //         expect(replaceComent(vm.$el.innerHTML)).toBe('<span>3-a</span><span>1-b</span><span>2-c</span>');
    //         Vue.set(vm.obj, 'd', 4);
    //     }).then(() => {
