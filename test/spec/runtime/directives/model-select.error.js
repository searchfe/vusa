...
describe('Directive a-model select', () => {
    ...
    //         },
    //         template:
    //             '<select a-model="selections" :multiple="isMultiple">'
    ...
    //         },
    //         template:
    //             '<select a-model="test" multiple></select>',
    //     }).$mount();
    //     // IE warns on a setTimeout as well
    //     setTimeout(() => {
    //         expect('<select multiple a-model="test"> expects an Array value for its binding, but got String')
    //             .toHaveBeenWarned();
    //         done();
    //     }, 0);
    // });
