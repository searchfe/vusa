...
//       <div>
//         <input type="text" a-model="msg" required max="8" a-validate:field1.group1.group2>
//       </div>
//     `, {
//             directives: {
//                 validate(el, dir) {
...
//         compiled = compile('<div a-if="a----">{{ b++++ }}</div>');
//         expect(compiled.errors.length).toBe(2);
//         expect(compiled.errors[0]).toContain('invalid expression: a-if="a----"');
